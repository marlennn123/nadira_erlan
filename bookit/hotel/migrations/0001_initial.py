    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='characteristics', to='hotel.hotel')),
            ],
        ),
        migrations.AddField(
            model_name='hotel',
            name='photos',
            field=models.ManyToManyField(blank=True, related_name='photos', to='hotel.photo'),
        ),
        migrations.CreateModel(
            name='Room',
            fields=[
        ...
        migrations.CreateModel(
            name='CharacteristicRoom',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.CharField(max_length=100)),
                ('value', models.CharField(max_length=100)),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='characteristics_room', to='hotel.room')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotel.hotel')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='hotel.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('status', models.CharField(choices=[('Активно', 'Активно'), ('Бронь', 'Бронь')], default='Активно', max_length=20)),
                ('room', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='hotel.room')),
