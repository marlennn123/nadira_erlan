...
urlpatterns = [
    ...
    path('room/<int:pk>/', RoomViewSets.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}),
         name='room_detail'),
    path('photoroom/', PhotoRoomViewSets.as_view({'get': 'list', 'post': 'create'}),
         name='photoroom_list'),
    path('photoroom/<int:pk>/', PhotoRoomViewSets.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}),
         name='photoroom_detail'),
